                        ...
                        <ul class="blog-masonry blog-wrapper grid grid-3col xl-grid-3col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-double-extra-large">
                            ...
                            <li class="grid-item wow animate__fadeIn">
                                <div class="blog-post border-radius-5px bg-white">
                                    ...
                                    <div class="blog-post-image">
                                        <a href="page3.php" title=""><img src="images/images/dell-7Bmk9mAXP2I-unsplash.jpg" alt=""></a>
                                    </div>
                                    <div class="post-details padding-3-rem-lr padding-2-half-rem-tb lg-padding-2-rem-all md-padding-2-half-rem-tb md-padding-3-rem-lr">
                                        <a href="page3.php" class="alt-font font-weight-500 text-extra-medium text-extra-dark-gray text-green-hover d-block margin-15px-bottom">Recognizing the need is the primary condition design</a>
                            ...
                            <li class="grid-item wow animate__fadeIn" data-wow-delay="0.2s">
                                <div class="blog-post border-radius-5px bg-white">
                                    ...
                                    <div class="blog-post-image">
                                        <a href="page3.php" title=""><img src="images/images/mailchimp-Vc2dD4l57og-unsplash.jpg" alt=""></a>
                                    </div>
                                    <div class="post-details padding-3-rem-lr padding-2-half-rem-tb lg-padding-2-rem-all md-padding-2-half-rem-tb md-padding-3-rem-lr">
                                        <a href="page3.php" class="alt-font font-weight-500 text-extra-medium text-extra-dark-gray text-green-hover d-block margin-15px-bottom">Computers are to design as microwaves are to cooking</a>
                                        <p>Lorem ipsum is simply dummy text of printing and typesetting industry lorem ipsum been dummy...</p>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="grid-item wow animate__fadeIn" data-wow-delay="0.4s">
                                <div class="blog-post border-radius-5px bg-white">
                                    ...
                                    <div class="blog-post-image">
                                        <a href="page3.php" title=""><img src="images/images/dell-SGY0LIfTKZ4-unsplash.jpg" alt=""></a>
                                    </div>
                                    <div class="post-details padding-3-rem-lr padding-2-half-rem-tb lg-padding-2-rem-all md-padding-2-half-rem-tb md-padding-3-rem-lr">
                                        <a href="page3.php" class="alt-font font-weight-500 text-extra-medium text-extra-dark-gray text-green-hover d-block margin-15px-bottom">Fashion and interior design are one and the same</a>
                                        <p>Lorem ipsum is simply dummy text of printing and typesetting industry lorem ipsum been dummy...</p>
                                    </div>
                                </div>
                            </li>
                    ...
                    <div class="col-12 col-lg-8 col-md-9 text-center">
                        <div class="row wow animate__fadeIn" data-wow-delay="0.8s">
                            <div class="col-12 text-center margin-6-rem-top">
                                <a href="page3.php" class="btn btn-fancy btn-medium btn-white btn-round-edge btn-box-shadow">See all services</a>
                            </div>
                        </div>
                    </div>
                </div>
