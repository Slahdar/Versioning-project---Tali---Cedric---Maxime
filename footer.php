 <!-- start footer -->
 <footer class="footer-startup footer-light background-position-right background-no-repeat" style="background-image: url('/images/images/home-startup-footer-down-bg.jpg');">
     <div class="footer-separate">
         <div class="container-fluid">
             <div class="row">
                 <div class="col-12 h-65px lg-h-30px background-position-center-top background-no-repeat" style="background-image: url('/images/images/home-startup-footer-shadow.png');">
                 </div>
             </div>
         </div>
     </div>
         ...
         <div class="container">
             <div class="row align-items-center">
                 <div class="col-12 col-sm-4 text-center text-sm-start xs-margin-20px-bottom">
                     <a href="index.html" class="footer-logo"><img src="images/images/logo/logo-green-dark.png" data-at2x="images/images/logo/logo-green-dark.png" alt=""></a>
                 </div>
                 <div class="col-12 col-sm-8 text-center text-sm-end last-paragraph-no-margin">
                     <p>&copy; 2022 Versioning <a href="https://github.com/Slahdar/Versioning-project---Tali---Cedric---Maxime.git" target="_blank" class="text-decoration-line-bottom text-extra-dark-gray font-weight-500">Notre Github</a></p>
                 </div>
             </div>
         </div>
     </div>
